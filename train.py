...
class Trainer(object):
    def __init__(self, args):
        ...
        # # Define network
        model = MCFINet(num_classes=self.nclass,
    ...
    def train_acc(self, epoch):
        ...
        Acc = self.evaluator.Pixel_Accuracy()
        self.writer.add_scalar('train_total_loss_epoch', train_loss, epoch)
    ...
    def validation(self, epoch):
        ...
        self.writer.add_scalar('val_total_loss_epoch', test_loss, epoch)
...
def main():
    ...
    parser.add_argument('--backbone', type=str, default='resnet-101',
                        choices=['resnet-50', 'resnet-101', 'xception', 'drn', 'mobilenet'],
                        help='backbone name (default: resnet)')
    parser.add_argument('--out-stride', type=int, default=32,
                        help='network output stride (default: 8)')
    parser.add_argument('--dataset', type=str, default='isprs_Vaihingen',
                        choices=['pascal', 'coco', 'cityscapes', 'isprs_Vaihingen'],
    ...
    parser.add_argument('--checkname', type=str, default='resnet-101',
